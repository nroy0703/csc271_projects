// Function that has no parameters but does return the price of a device
// This function changes the text color of the price of the device based on the price range
